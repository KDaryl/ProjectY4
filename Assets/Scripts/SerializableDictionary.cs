...
using UnityEngine;
/// <summary>
/// Description: This script is an addon/import that allowed me to use dictionaries in the Unity Editor
/// as dictionarys are not automatically supported by the Unity Editor for inspectors.
/// None of the code below is mine and i do not claim it to be, this is just an impor to
/// better my workflow
/// </summary>
